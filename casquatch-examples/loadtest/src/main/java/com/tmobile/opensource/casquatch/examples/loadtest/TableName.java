...
public class TableName extends AbstractCasquatchEntity {
    ...
    */
    ...
    public TableName keys() {
        ...
        table_name.setKeyOne(this.getKeyOne());
        table_name.setKeyTwo(this.getKeyTwo());
        return table_name;
    }
