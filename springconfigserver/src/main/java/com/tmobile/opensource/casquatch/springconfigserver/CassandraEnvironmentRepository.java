...
import com.tmobile.opensource.casquatch.models.springconfig.Configuration;
...
public class CassandraEnvironmentRepository implements EnvironmentRepository {
    ...
    private final static Logger logger = LoggerFactory.getLogger(CassandraEnvironmentRepository.class);
     ...
     */	
	public CassandraEnvironmentRepository(CassandraDriver db) {		
		this.db = db;		
	}
