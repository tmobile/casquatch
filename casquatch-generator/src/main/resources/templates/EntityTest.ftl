...
public class ${naming.classToEmbeddedTests(naming.classToSimpleClass(class))} extends AbstractEntityTests<${naming.classToSimpleClass(class)}> {

    private static CasquatchDao casquatchDao;

    public ${naming.classToEmbeddedTests(naming.classToSimpleClass(class))}() {
